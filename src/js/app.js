...
function updateThemeSetting(id) {
    if($("#light-mode-switch").prop("checked") == true && id === "light-mode-switch"){
        ...
        $("#rtl-mode-switch").prop("checked", false);
        $("#bootstrap-style").attr('href','/static/css/bootstrap-dark.min.css');
        $("#app-style").attr('href','/static/css/app-dark.min.css');
        sessionStorage.setItem("is_visited", "dark-mode-switch");
    } else if($("#rtl-mode-switch").prop("checked") == true && id === "rtl-mode-switch"){
        $("#light-mode-switch").prop("checked", false);
        $("#dark-mode-switch").prop("checked", false);
        $("#bootstrap-style").attr('href','/static/css/bootstrap-rtl.min.css');
...
var toaster = document.getElementById("toast-message");
if (user_login) {
